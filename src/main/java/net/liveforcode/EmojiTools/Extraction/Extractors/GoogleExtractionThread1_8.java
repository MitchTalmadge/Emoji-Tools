...
public class GoogleExtractionThread1_8 extends ExtractionThread {
    ...
    public GoogleExtractionThread1_8(File font, File extractionDirectory, List<String> tableNames, List<Integer> tableOffsets, List<Integer> tableLengths, ExtractionManager extractionManager, ExtractionDialog extractionDialog) {
