...
class GlyphRecord(object):
    ...
    def __repr__(self):
        return "GlyphRecord[ glyphID: " + str(self.glyphID) + ", nMetaEntry: " + str(
            self.nMetaEntry) + ", offset: " + str(self.offset) + " ]"
...
class StringRecord(object):
    ...
    def __repr__(self):
        return "StringRecord [ labelID: " + str(self.labelID) + " aka " + getLabelString(self.labelID) \
               + ", offset: " + str(self.offset) + ", length: " + str(
            self.stringLen) + ", string: " + self.string + " ]"
