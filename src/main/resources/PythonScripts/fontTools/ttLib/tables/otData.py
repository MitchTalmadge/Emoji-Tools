otData = [
    ...
    ('Script', [
        ('Offset', 'DefaultLangSys', None, None,
    ...
    ('FeatureList', [
        ...
        ('struct', 'FeatureRecord', 'FeatureCount', 0,
    ...
    ('Feature', [
        ...
        ('uint16', 'LookupListIndex', 'LookupCount', 0,
    ...
    ('Lookup', [
        ...
        ('uint16', 'MarkFilteringSet', None, 'LookupFlag & 0x0010',
    ...
    ('BaseRecord', [
        ('Offset', 'BaseAnchor', 'ClassCount', 0,
    ...
    ('MarkLigPosFormat1', [
        ...
        ('Offset', 'LigatureCoverage', None, None,
    ...
    ('LigatureArray', [
        ...
        ('Offset', 'LigatureAttach', 'LigatureCount', 0,
    ...
    ('ComponentRecord', [
        ('Offset', 'LigatureAnchor', 'ClassCount', 0,
    ...
    ('Mark2Record', [
        ('Offset', 'Mark2Anchor', 'ClassCount', 0,
    ...
    ('ContextPosFormat1', [
        ...
        ('Offset', 'PosRuleSet', 'PosRuleSetCount', 0,
    ...
    ('ContextPosFormat2', [
        ...
        ('Offset', 'PosClassSet', 'PosClassSetCount', 0,
    ...
    ('PosClassSet', [
        ...
        ('Offset', 'PosClassRule', 'PosClassRuleCount', 0,
    ...
    ('ChainContextPosFormat1', [
        ...
        ('Offset', 'ChainPosRuleSet', 'ChainPosRuleSetCount', 0,
    ...
    ('ChainContextPosFormat2', [
        ...
        ('Offset', 'ChainPosClassSet', 'ChainPosClassSetCount', 0,
    ...
    ('ChainPosClassSet', [
        ...
        ('Offset', 'ChainPosClassRule', 'ChainPosClassRuleCount', 0,
    ...
    ('ChainPosClassRule', [
        ('uint16', 'BacktrackGlyphCount', None, None,
         'Total number of glyphs in the backtrack sequence (number of glyphs to be matched before the first glyph)'),
        ('uint16', 'Backtrack', 'BacktrackGlyphCount', 0,
        ...
        ('uint16', 'LookAhead', 'LookAheadGlyphCount', 0,
    ...
    ('ChainContextPosFormat3', [
        ...
        ('Offset', 'BacktrackCoverage', 'BacktrackGlyphCount', 0,
        ...
        ('Offset', 'InputCoverage', 'InputGlyphCount', 0,
        ...
        ('Offset', 'LookAheadCoverage', 'LookAheadGlyphCount', 0,
    ...
    ('ExtensionPosFormat1', [
        ...
        ('uint16', 'ExtensionLookupType', None, None,
    ...
    ('AlternateSubstFormat1', [
        ...
        ('Offset', 'AlternateSet', 'AlternateSetCount', 0,
    ...
    ('LigatureSubstFormat1', [
        ...
        ('Offset', 'LigatureSet', 'LigSetCount', 0,
    ...
    ('LigatureSet', [
        ...
        ('Offset', 'Ligature', 'LigatureCount', 0,
    ...
    ('ContextSubstFormat1', [
        ...
        ('Offset', 'SubRuleSet', 'SubRuleSetCount', 0,
    ...
    ('ContextSubstFormat2', [
        ...
        ('Offset', 'SubClassSet', 'SubClassSetCount', 0,
    ...
    ('SubClassSet', [
        ...
        ('Offset', 'SubClassRule', 'SubClassRuleCount', 0,
    ...
    ('ChainContextSubstFormat1', [
        ('uint16', 'SubstFormat', None, None, 'Format identifier-format = 1'),
        ('Offset', 'Coverage', None, None, 'Offset to Coverage table-from beginning of Substitution table'),
        ('uint16', 'ChainSubRuleSetCount', None, None,
         'Number of ChainSubRuleSet tables-must equal GlyphCount in Coverage table'),
        ('Offset', 'ChainSubRuleSet', 'ChainSubRuleSetCount', 0,
    ...
    ('ChainSubRuleSet', [
        ...
        ('Offset', 'ChainSubRule', 'ChainSubRuleCount', 0,
    ...
    ('ChainContextSubstFormat2', [
        ...
        ('Offset', 'ChainSubClassSet', 'ChainSubClassSetCount', 0,
    ...
    ('ChainSubClassSet', [
        ...
        ('Offset', 'ChainSubClassRule', 'ChainSubClassRuleCount', 0,
    ...
    ('AttachList', [
        ...
        ('Offset', 'AttachPoint', 'GlyphCount', 0,
    ...
    ('LigCaretList', [
        ...
        ('Offset', 'LigGlyph', 'LigGlyphCount', 0,
    ...
    ('LigGlyph', [
        ...
        ('Offset', 'CaretValue', 'CaretCount', 0,
    ...
    ('BaseScript', [
        ...
        ('struct', 'BaseLangSysRecord', 'BaseLangSysCount', 0,
    ...
    ('MinMax', [
        ...
        ('struct', 'FeatMinMaxRecord', 'FeatMinMaxCount', 0,
    ...
    ('JSTF', [
        ...
        ('struct', 'JstfScriptRecord', 'JstfScriptCount', 0,
    ...
    ('JstfScript', [
        ...
        ('struct', 'JstfLangSysRecord', 'JstfLangSysCount', 0,
    ...
    ('JstfPriority', [
        ...
        ('Offset', 'ExtensionDisableGSUB', None, None,
        ...
        ('Offset', 'ExtensionDisableGPOS', None, None,
         'Offset to Extension Disable JstfGSUBModList table-from beginning of JstfPriority table-may be NULL'),
        ('Offset', 'ExtensionJstfMax', None, None,
    ...
    ('JstfGSUBModList', [
        ...
        ('uint16', 'GSUBLookupIndex', 'LookupCount', 0,
         'Array of LookupIndex identifiers in GSUB-in increasing numerical order'),
    ]),

    ('JstfGPOSModList', [
        ('uint16', 'LookupCount', None, None, 'Number of lookups for this modification'),
        ('uint16', 'GPOSLookupIndex', 'LookupCount', 0,
    ...
    ('MathConstants', [
        ...
        ('MathValueRecord', 'AccentBaseHeight', None, None,
        ...
        ('MathValueRecord', 'FlattenedAccentBaseHeight', None, None,
        ...
        ('MathValueRecord', 'SubscriptShiftDown', None, None,
        ...
        ('MathValueRecord', 'SubscriptTopMax', None, None,
        ...
        ('MathValueRecord', 'SubscriptBaselineDropMin', None, None,
        ...
        ('MathValueRecord', 'SuperscriptShiftUp', None, None,
         'Standard shift up applied to superscript elements. Suggested: os2.ySuperscriptYOffset.'),
        ('MathValueRecord', 'SuperscriptShiftUpCramped', None, None,
         'Standard shift of superscripts relative to the base, in cramped style.'),
        ('MathValueRecord', 'SuperscriptBottomMin', None, None,
        ...
        ('MathValueRecord', 'SuperscriptBaselineDropMax', None, None,
        ...
        ('MathValueRecord', 'SubSuperscriptGapMin', None, None,
         'Minimum gap between the superscript and subscript ink. Suggested: 4x default rule thickness.'),
        ('MathValueRecord', 'SuperscriptBottomMaxWithSubscript', None, None,
        ...
        ('MathValueRecord', 'StackGapMin', None, None,
        ...
        ('MathValueRecord', 'StackDisplayStyleGapMin', None, None,
        ...
        ('MathValueRecord', 'FractionNumeratorGapMin', None, None,
        ...
        ('MathValueRecord', 'FractionNumDisplayStyleGapMin', None, None,
        ...
        ('MathValueRecord', 'FractionRuleThickness', None, None,
         'Thickness of the fraction bar. Suggested: default rule thickness.'),
        ('MathValueRecord', 'FractionDenominatorGapMin', None, None,
        ...
        ('MathValueRecord', 'FractionDenomDisplayStyleGapMin', None, None,
    ...
    ('MathVariants', [
        ...
        ('Offset', 'HorizGlyphConstruction', 'HorizGlyphCount', 0,
    ...
    ('MathGlyphConstruction', [
        ('Offset', 'GlyphAssembly', None, None,
    ...
    ('GlyphPartRecord', [
        ...
        ('uint16', 'EndConnectorLength', None, None,
